...
class LoginPresenter:
    ...
    def handle_login(self, username: str, password: str):
        ...
        if result.ok:
            ...
            #self.on_success(username) 						#Esta es la parte que se cambió
            self.on_success( username, result.role,)        # Antes solo se enviaba el nombre de usuario, ahora usuario + rol
        else:
